...
function calcularCosto() {
    ...
    document.getElementById("resultado").innerText = `Costo total: ${resultado.toFixed(2)} Millones`;
}
...
function calcularArea() {
    ...
    document.getElementById("resultado").innerText = `Área del canal: ${resultado.toFixed(2)} unidades²`;
}
...
function calcularEsfuerzo() {
    ...
    const resultado = A !== 0 ? F / A : "Área no puede ser cero";
